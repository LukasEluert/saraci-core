...
const LEAD_FIELDS =
  "id, firma, branche, region, domain, telefon, email, akquise_status, assigned_to, notiz, aktion_benoetigt, aktion_notiz, aktion_seit, bearbeitung_von, bearbeitung_seit, archiviert, created_at";
